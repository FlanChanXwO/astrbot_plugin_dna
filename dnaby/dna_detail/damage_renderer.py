...
from .damage_service import RoleDamageBuild, get_calculation_skill_levels
...
def _lineup(build: RoleDamageBuild) -> list[dict[str, str]]:
    result = [{"label": "角色", "name": build.role_detail.charName}]
    for label, weapon in (
...
def _success_payload(
    ...
    return {
        ...
        "element": build.role_detail.elementName,
