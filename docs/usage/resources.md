...
O14 资源审查记录（2026-08-30）：公共仓库 `main` 的候选提交为
`5d76860141d9ab5052417df25ccc9f5a929ff06b`，其 Git root tree 为
`6cf9d38b417825a27d63f8ecdc5f924fc3eb04ed`；已发布 generation 的完整内容摘要为
`92796fd40415375a989154fd762dfa61551d5b03b4c9f491638c576318818bc4`。该提交的 manifest、12 个必需目录、109 个已跟踪
文件、93 个 PNG、3 个 TTF、兑换码 schema/语义、符号链接和定向秘密痕迹均已审查；插件只接受
规范远端的 `main`，不接受投稿分支或镜像独有 ref。审查只证明结构、内容可解码和仓库边界，
不把插件 GPL-3.0 推广为第三方素材许可。该资源仓库没有统一 `LICENSE`、`NOTICE` 或来源清单，
...
则复用硬保留期作为扫描周期，避免零秒忙循环，不增加无产品语义的固定间隔配置。
