...
PLAYER_ORIGINAL_DISABLED = "角色原图功能已关闭"
PLAYER_ORIGINAL_REPLY_REQUIRED = "请引用角色详情图后再发送原图"
PLAYER_ORIGINAL_NOT_FOUND = "未找到所引用角色详情图的原图"
...
__all__ = [
    ...
    "PLAYER_ORIGINAL_DISABLED",
    "PLAYER_ORIGINAL_NOT_FOUND",
    "PLAYER_ORIGINAL_REPLY_REQUIRED",
