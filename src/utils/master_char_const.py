...
MASTER_CHAR_FEMALE_IDS = frozenset(
    (MASTER_CHAR_FEMALE_LIGHT_ID, MASTER_CHAR_FEMALE_DARK_ID)
)
MASTER_CHAR_MALE_IDS = frozenset((MASTER_CHAR_MALE_LIGHT_ID, MASTER_CHAR_MALE_DARK_ID))
MASTER_CHAR_LIGHT_IDS = frozenset(
    (MASTER_CHAR_FEMALE_LIGHT_ID, MASTER_CHAR_MALE_LIGHT_ID)
)
...
MASTER_CHAR_ID_BY_NAME = {
    name: char_id for char_id, name in MASTER_CHAR_NAME_BY_ID.items()
}
