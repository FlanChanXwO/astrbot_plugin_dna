...
class WebSocketManager:
    ...
    def _extract_user_id(self, token: str) -> str:
        ...
        except (binascii.Error, json.JSONDecodeError, UnicodeDecodeError, TypeError, ValueError) as error:
    ...
    def _create_connection(self, token: str, dev_code: str, ready_event: threading.Event) -> Any | None:
        try:
            key = (token, dev_code)
    ...
    def get_connection(self, token: str, dev_code: str, wait_ready: bool = False, timeout: float = 5) -> Any | None:
